...
int get_file_mod_date(char *path, char *ret_str, char* mod_date)
{
    struct stat attr;
    stat(path, &attr);
    int flag = 1;
    ...
    strcat(temp, "\0");
    if (strcmp(strsep(mod_date, ", "), temp) != 0) flag = 0;
    memcpy(format_date + 3, ", ", 2);
        ...
        if (strcmp(cmd, "GET") == 0)
        {
            ...
            else
            {
                ...
                while (startline != NULL)
                {
                    ...
                    strcpy(header, strsep(&startline, ": "));
                    if (strcmp(header, "If-Modified-Since") == 0)
                    {
                        
                        if (get_file_mod_date(get_fname, mod_date, startline) == 0)
                        {
                ...
                if (access(get_fname, F_OK) != -1)
                {
                    ...
                    if (strcmp(ext, ".html") == 0)
                    {
                        ...
                        get_file_mod_date(get_fname, date, startline);
